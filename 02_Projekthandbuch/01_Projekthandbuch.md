...
Die Anwendung Scrabble ist eine Server-Client-Applikation, die mithilfe von Java realisiert wird. Server und Client kommunizieren über RMI. Die Anwendung ermöglicht es Spieler:innen das Brettspiel Scrabble online, gemäß den originalen Regeln zu spielen. Die Spieler:innen haben die Möglichkeit entweder eine Spielsitzung zu erstellen und diese für andere Mitspieler freizugeben.

###	Vertragsbasis

Das Projekt wird im Rahmen des Moduls „Secure Software Engineering“ erstellt. Es gelten die folgenden Rahmenbedingungen:

• Der wichtigste Bestandteil der Portfolioprüfung, da ein komplettes Software-Projekt im Team durchgeführt wird und Ihre Rolle im Team und die erstellten Produkte in die Bewertung einfließen.
...
• Sie erhalten i.A. wöchentlich montags in der Vorlesung neue Aufgabenblätter, auf denen die vom Team zu erledigenden Aufgaben beschrieben sind. Diese Aufgabenblätter werden auch auf dem Dokumentenserver und auf Ilias zur Verfügung gestellt.
• Pro Woche gibt es ein Treffen im Team mit Ihrem Betreuer/Ihrer Betreuerin. Die Teams sollten sich nach Bedarf auch außerhalb dieses Termins treffen. 
...
• Alle erstellten Dokumente müssen im polf-Format auf dem Dokumentenserver abgelegt werden.
• Der erstellte Sourcecode muss auf dem zentralen Subversion-Server verwaltet werden:
https://subversion.unibw.de/etti6se/
...
• Wieviele Punkte Sie für das Praktikum und die erstellen Produkte bekommen, hängt von den Teamtreffen, den Dokumenten auf dem Dokumentenserver und dem Sourcecode auf dem Subversion-Server ab.

Die Bewertung der Ergebnisse findet unter den folgenden Bedingungen statt:

• Insgesamt können Sie im Rahmen vom Praktikum und der anschließenden mündlichen Prüfung 225 Punkte erreichen.
...
• Fehlzeiten werden nach Absprache mit dem Team und dem Betreuer / der Betreuerin nachgearbeitet. 
...
| Vorlesung  | Praktikum  | Produkte                                                | Abgabetermin      |
...
| Boessendoerfer    | Fachliche Chefdesignerin  | anna.boessendoerfer@unibw.de |  
...
Auf der Kundenseite steht und Frau Prof. Doe (prof.doe@unibw.de) zur Verfügung.
...
Kommunikation mit dem Kunden:                https://mattermost.dublin.etti.unibw-muenchen.de/edu-se/channels/secure-software-engineering
Komunikation intern:                         https://discord.com/invite/R2KxFX3U / https://mattermost.com 
Zur Bearbeitung von UML Diagramm:            https://www.visual-paradigm.com
Designentwurf der Oberfläche:                https://www.drawio.com       

## Referenzliste

Spielregeln: https://scrabble-info.de/wp-content/uploads/2016/03/Allgemeine-Scrabble-Spielregeln.pdf
Infos Spielbrett: https://de.wikipedia.org/wiki/Scrabble#/media/Datei:Scrabbleboard.svg
